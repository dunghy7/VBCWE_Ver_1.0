...
@Component
public class GearsDataTable4Sub6Validator implements Validator {
    ...
    public boolean supports(Class<?> clazz) {
        return GearsDataTable4Sub6Form.class.isAssignableFrom(clazz);
    }
    ...
    public void validate(Object target, Errors errors) {
        ...
        GearsDataTable4Sub6Form table4Sub6Form = GearsDataTable4Sub6Form.class.cast(target);
        // Lấy dữ liệu trên màn hình
        List<GearsDataTable4DTO> dataTable4DtoList = table4Sub6Form.getDataTable4DtoList();
        // thực hiện validate
