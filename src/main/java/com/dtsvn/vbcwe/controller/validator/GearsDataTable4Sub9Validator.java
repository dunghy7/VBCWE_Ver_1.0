...
@Component
public class GearsDataTable4Sub9Validator implements Validator {
    ...
    public boolean supports(Class<?> clazz) {
        return GearsDataTable4Sub9Form.class.isAssignableFrom(clazz);
    }
    ...
    public void validate(Object target, Errors errors) {
        ...
        GearsDataTable4Sub9Form table4Sub9Form = GearsDataTable4Sub9Form.class.cast(target);
        // Lấy dữ liệu trên màn hình
        List<GearsDataTable4DTO> dataTable4DtoList = table4Sub9Form.getDataTable4DtoList();
        // thực hiện validate
