...
@Component
public class GearsDataTable4Sub7Validator implements Validator {
    ...
    public boolean supports(Class<?> clazz) {
        return GearsDataTable4Sub7Form.class.isAssignableFrom(clazz);
    }
    ...
    public void validate(Object target, Errors errors) {
        ...
        GearsDataTable4Sub7Form table4Sub7Form = GearsDataTable4Sub7Form.class.cast(target);
        // Lấy dữ liệu trên màn hình
        List<GearsDataTable4DTO> dataTable4DtoList = table4Sub7Form.getDataTable4DtoList();
        // thực hiện validate
